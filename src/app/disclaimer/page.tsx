...
const SITE_ORIGIN = 'https://slotspk.com.pk';

export const metadata: Metadata = {
  title: 'Disclaimer – Slots PK Legal Notice',
  description:
    'Read the Slots PK disclaimer. Legal notice covering responsible gaming, age restrictions, external links, and limitations of liability for our gaming platform.',
  alternates: {
    canonical: `${SITE_ORIGIN}/disclaimer`,
  },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Disclaimer – Slots PK Legal Notice',
    description: 'Read the Slots PK disclaimer covering responsible gaming, age restrictions, and limitations of liability.',
    url: `${SITE_ORIGIN}/disclaimer`,
    siteName: 'Slots PK',
    type: 'website',
    images: [{ url: `${SITE_ORIGIN}/feature/og-image.webp`, width: 1200, height: 630, alt: 'Slots PK Disclaimer' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Disclaimer – Slots PK Legal Notice',
    description: 'Read the Slots PK legal disclaimer for responsible gaming, age restrictions, and limitations of liability.',
          ...
          <div className="bg-secondary rounded-lg p-6 md:p-8">
            <div className="prose prose-lg max-w-none text-gray-300">
              ...
              <ul className="list-none mb-4">
                ...
                <li className="mb-2">
                  By visiting the <Link href="/contact-us" className="text-accent hover:underline">Contact Us</Link> page on our website
                </li>
              </ul>
            </div>
          </div>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Disclaimer', item: `${SITE_ORIGIN}/disclaimer` },
            ],
          }),
        }}
      />
