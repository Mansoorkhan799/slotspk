...
export const metadata: Metadata = {
  title: 'Privacy Policy – Slots PK Data Protection',
  description:
    'Read the Slots PK privacy policy to understand how we collect, use, and protect your personal information. Your privacy and data security are our priority.',
  alternates: {
  ...
  openGraph: {
    title: 'Privacy Policy – Slots PK Data Protection',
    description: 'Read the Slots PK privacy policy. We explain how we collect, use, and protect your personal information.',
    url: `${SITE_ORIGIN}/privacy`,
    siteName: 'Slots PK',
    type: 'website',
    images: [{ url: `${SITE_ORIGIN}/feature/og-image.webp`, width: 1200, height: 630, alt: 'Slots PK Privacy Policy' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Privacy Policy – Slots PK Data Protection',
    description: 'Read the Slots PK privacy policy for information on how your data is collected and protected.',
